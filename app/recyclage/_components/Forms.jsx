...
function NewRecyclage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = {
      ...
      Photo_pormis: uploadedNationalIdPhoto,
      Photo_CNI_ou_Recepice: uploadedPassportPhoto,
    };

    // Envoie les données à la Google Sheet
    axios
      .post(`https://sheet.best/api/sheets/ce4087b5-137d-4560-b0c8-b2ff05415f99/tabs/Recyclage`, data)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    if (showPopup && countdown > 0) {
      ...
      clearInterval(timer)
      window.location.href = '/link-paiement/paiementrecyclage' // Redirection
    }
  ...
  return (
    <div className="max-w-4xl mx-auto h-screen my-auto mt-4 p-3 sm:p-0">
      <div>
        ...
        <p className="w-xl my-8 text-gray-700 sm:text-md block">
          ...
          L&apos;auto-école Chancimi propose un programme aussi une formation pour les conducteurs souhaitant
           se recycler ou se perfectionner dans le domaine de la conduite responsable et durable.
        </p>
        <p className="text-2xl font-bold mb-4">Prix par séance : 7,000 FCFA</p>
      </div>
      {/* form */}
      <form
        autoComplete="off"
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  <label>Téléverser une photo de votre permis actuel</label>
                  <Input
                ...
                <div>
                  <label>Téléverser une photo de votre CNI ou récépicé</label>
                  <Input 
