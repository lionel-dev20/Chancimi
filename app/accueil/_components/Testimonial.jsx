...
export function Testimonial() {
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden  bg-background">
        ...
        <p className="max-w-[40rem] mb-10">Toi aussi tu peux le faire, comme tous nos autres édutiants l&apos;ont fait, laisse toi guider et accompagner tout au long de ton apprentissage de conduire avec notre école Chancimi .</p>
