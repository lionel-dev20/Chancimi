    ...
    <div className="sm:flex sm:gap-6 mx-auto justify-between items-center">
        <Card className="bg-blue-300 mb-6">
           <CardHeader>
              ...
              Apprenez comme vous le souhaitez, vous le voulez avec notre plateforme Chanicmi</CardDescription>
           </CardHeader>
       </Card>
        ...
        <Card className="bg-primary mb-6">
           <CardHeader>
              ...
              <Image src='/serv2.png' width={500} height={500} alt="cours autoecole"  className="rounded-b-[8px]"/>
           </CardHeader>
       </Card>
        ...
        <Card className="bg-blue-300 mb-6">
           <CardHeader>
              <Image src='/serv3.png' width={500} height={500} alt="cours autoecole"  className="rounded-t-[8px]"/>
              <CardDescription className="flex text-center items-center justify-center py-16 text-white text-[18px] font-semibold leading-8 px-4 sm:px-2 sm:w-96">
