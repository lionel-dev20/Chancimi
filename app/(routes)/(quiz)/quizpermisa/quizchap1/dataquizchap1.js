// quiz du chaptire 1 du cours Permis A
const dataquizchap1 = [
    {
    ...
    {
      question: "3-Deux signalisation à la sortie d’une agglomération",
    ...
    {
      question: "4-Deux signalisation qui interdisent l’arrêt",
    ...
    {
      question: "5-Deux signalisation qui interdisent le stationnement",
      options: ["a) La ligne discontinue rouge blanc et la zone zébra", 
        "b) La ligne de rive continue jaune et la ligne discontinue jaune", 
        "c) La ligne discontinue jaune et le zigzag de couleur jaune"],
    ...
    {
      question: "7- La ligne de rive jaune discontinue",
      options: ["a) Stationnement interdit", 
        "b) Arrêt interdit", 
        "c) Arrêt et stationnement interdit "],
    ...
    {
      question: "8-La ligne de rive alternative rouge blanc",
      options: ["a) Stationnement interdit", 
        "b) Arrêt interdit", 
        "c) Arrêt et stationnement interdit"],
    ...
    {
      question: "9- Le panneau de danger est de forme",
    ...
    {
      question: "10- La signalisation routière comprend",
