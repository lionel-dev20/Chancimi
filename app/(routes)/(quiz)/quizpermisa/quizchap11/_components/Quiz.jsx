      ...
      {timeLeft > 0 && !quizFinished && (
        <div className='w-full'>
          ...
          <h3 className='border-b-2 border-gray-100 text-xl font-bold text-gray-700 my-6'>
            Question {currentQuestion + 1} sur {dataquizchap11.length}
          </h3>
          
          {dataquizchap11[currentQuestion].image && (
            <Image
              src={dataquizchap11[currentQuestion].image}
              alt="Illustration"
              width={600}
              height={350}
          ...
          <p className='sm:text-[20px] text-md font-semibold text-gray-700 py-4'>
            {dataquizchap11[currentQuestion].question}
          </p>
          <div className='w-full'>
