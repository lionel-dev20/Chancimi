...
function WelcomeBannerDashboard({user}) {
    return (
        <div className='flex gap-5 items-center bg-white rounded-[4px] p-5'>
            ...
            <div>
              <h2 className='font-bold text-[32px] text-primary'>Bon retour 
                <span className='text-gray-700'> {user?.fullName}</span></h2>
              <h2 className='text-[16px] font-light text-slate-500'>Continuons là, où vous vous êtes arrêté dernièrement,<br />
