...
const Paiement3tranche1 = () => {
  ...
  const ussdCode = '#150*14*357550*656784922*33285#';
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-10 rounded-md shadow-md border-[0.5] relative">
            ...
            <h1 className='text-lg font-bold'>Méthode de paiement</h1>
...
export default Paiement3tranche1;
