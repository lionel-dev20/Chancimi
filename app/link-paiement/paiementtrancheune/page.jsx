...
const UssdPage = () => {
  ...
  const isOrangeCameroon = (number) => {
    return number.startsWith("6") && number.length === 9; // Vérifie si le numéro commence par 6 (pour Orange)
  };

  const isMTNCameroun = (number) => {
    return number.startsWith("7") && number.length === 9; // Vérifie si le numéro commence par 7 (pour MTN)
  };
  ...
  const ussdOrangeCode = "#150*14*357550*656784922*80000#";
  const ussdMTNCode = "*126*14*679192659*80000#"; // Code USSD pour MTN
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-10 rounded-md shadow-md border-[0.5] relative">
            ...
            <h1 className="text-lg font-bold mb-2">
              Montant du paiement 80,000 <sup className="mx-2">FCFA</sup>
            </h1>
